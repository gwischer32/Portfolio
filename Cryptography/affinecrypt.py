...
message = ''

# print(find_index_of_coincidence(message))
# letter_freq = count_letter_freqs(message)
# print(find_mutual_index_of_coincidence(english_freq,letter_freq))

a=affine_cryptanalysis('6')
print(a)